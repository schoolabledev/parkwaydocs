...
description: "This endpoint is utilized to search wallets you have created (Include the owner information of the wallet). it comes with filters to streamline your search"
